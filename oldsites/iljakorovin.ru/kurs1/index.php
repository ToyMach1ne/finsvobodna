    ...
    <div id="shape-box">
      ...
      <div id="right">
        <div id="forma-right">
          ...
          <p class="txt_forma_right">Дату и время узнайте по ссылке Записаться<br>Зарегистрируйтесь прямо сейчас - количество мест <span>ограничено!</span></p>
          <!--timer  
          ...
          <div class="row form_top">
            ...
            <div id="f-center">
              <p>
				...
				<a href="http://goo.gl/Znb3l1 " class="btn btn-danger btn-lg btn-block" rel="nofollow noopener" target="_blank">Записаться</a>
...
2х дневны курс «Торговля временем на акциях» - возможно только купить запись <a href="http://goo.gl/Dp5rtB" rel="nofollow noopener" target="_blank">Ссылка</a> 
  ...
  <div class="video-work">
     <div class="row">
  <h2>ПОЧЕМУ 1260 УЧЕНИКОВ УЖЕ ПРОШЛИ ОБУЧЕНИЕ</h2>
