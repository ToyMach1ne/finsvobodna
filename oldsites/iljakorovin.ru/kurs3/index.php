...
<head>
<meta charset="utf-8">
<title>Курс: "Прикрытый интрадей" от Ильи Коровина - лучшего Трейдера в рейтинге Финама </title>
    ...
    <div id="shape-box">
      ...
      <div id="right">
        <div id="forma-right">
          ...
          <p class="txt_forma_right">Дату и время узнайте по ссылке Записаться<br>+ 2 месяца поддержки: общение с Ильей Коровиным после курса в закрытом Skype-чате. Обсуждение результатов, рекомендации - все это входит в стоимость курса.<br>Стоимость 58 000 руб.<br>Количество мест <span>ограничено!</span></p>
          <!--timer  
...
<p class="hellotimercopy"></p>
          ...
          <div class="row form_top">
            ...
            <div id="f-center">
              ...
              <p>
                <a href="http://goo.gl/FpWiCL" class="btn btn-danger btn-lg btn-block" rel="nofollow noopener" target="_blank">Записаться</a>
		        </p>
...
2х дневны курс «Торговля временем на акциях» - возможно только купить запись <a href="http://goo.gl/Dp5rtB" rel="nofollow noopener" target="_blank">Ссылка</a> 
  ...
  <div class="video-work">
    <div class="row">
  <h2>ПОЧЕМУ 245 УЧЕНИКОВ УЖЕ ПРОШЛИ ОБУЧЕНИЕ</h2>
  ...
  <div class="preimushestva">
   ...
   <div><b>Илья Коровин</b></br>
	...
	<h2>Программа курса "ПРИКРЫТЫЙ ИНТРАДЕЙ" </h2><br> 
 <ul class="neznanie_zakona">
<li style="font-weight:bold">1-ый, 2-ой: Теория. </li>
<ul>
<li style="font-style:italic">Доскональное описание Стратегии "Прикрытый Интрадей".</li>

 </ul>
  <li style="font-weight:bold"><br>3-ий день, 4-ый и 5-ый день: Практикум.</li>
<ul>
<li style="font-style:italic">Онлайн торговля по стратегии "Прикрытый Интрадей" вместе с Автором стратегии, с возможностью реального заработка.</li>

</ul>
 </ul>
	
	
    <h2>Какие задачи решает данный курс</h2>
      <ul class="neznanie_zakona">

	  
<li>1. Вы бы хотели зарабатывать на рынке независимо от того – растет он или падает или стоит на месте?</li>
<li>2. Вы бы хотели зарабатывать на рынке, не умея и даже не пытаясь его предсказывать?</li>
<li>3. Вы бы хотели иметь потенциально неограниченную прибыль при всегда ограниченных убытках и при этом не заботиться о правильном выставлении  стоп-лоссов?</li>
<li>4. Вы бы хотели иметь возможность отвлекаться на рынок лишь тогда, когда у вас есть на это время, но при этом постоянно иметь направленные рыночные позиции с прикрытыми рисками, даже, когда вас нет возле монитора?</li>
<li>5. Вы бы хотели постоянно испытывать психологический комфорт при торговле, ощущать себя не дичью, а охотником, планомерно расставляющим силки и получающим прибыль при любом неожиданном движении рынка в любую сторону?</li>

<li><br>Тогда мы предлагаем вам уникальный авторский курс <b>“Прикрытый Интрадей”</b>!
</ul>
      </div>
  ...
  <div id="how-work">
    <div id="tarif">
      <h6 style="text-align: center;"><span style="color:#ffffff">Стратегия "Прикрытого интрадея":</span></h6>
        <ul class="delaem">
		
		<li>Это стратегия, объединяющая в себе уникальные возможности двух закрытых рыночных каст – интрадейщиков-скальперов и опционщиков!	</li>

	<li>Это стратегия, которая за первый же месяц открытого публичного онлайн тестирования <span><a href="http://www.comon.ru/managers/?io=False&tm=1&tr=1" target="_blank" style="text-decoration:underline; color:#ffffff"><span style="color:ffffff">в рейтинге трейдеров Финама сайте Comon.ru</a></span> побила все рекорды этого ресурса по доходности!</li>

	<li>Эта стратегия - самая идеальная практическая методика и вершина авторской философии “Торговля Временем”! </li>


<h6 style="text-align: center;">Что Вы получите на данном Курсе:</h6>
     
<li>Доскональное описание стратегии  от ее Автора, со  всеми практическими  нюансами.</li>
<li>ОБЯЗАТЕЛЬНЫЙ БОНУС! Практикум с возможностью онлайн заработка вместе с Автором стратегии!</li>
<li><br>+ 2 месяца поддержки: общение с Ильей Коровиным после курса в закрытом Skype-чате.<br>Обсуждение результатов, рекомендации - все это входит в стоимость курса.</li>



<li style="text-align: center;"><br>Стоимость: 58 000 рублей</li>
