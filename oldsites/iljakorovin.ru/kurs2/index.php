...
<head>
<meta charset="utf-8">
<title>Вебинар: "Торговля Временем на опционах" от Ильи Коровина - лучшего Трейдера в рейтинге Финама </title>
  ...
  <div id="shape">
    <div id="shape-box">
      <div class="descrip">
        ...
        <h1>Вебинар<br> "Торговля Временем на опционах"</h1> 
      ...
      <div id="right">
        <div id="forma-right">
          ...
          <p class="txt_forma_right">Дату и время узнайте по ссылке Записаться<br>+ 2 месяца поддержки: общение с Ильей Коровиным после курса в закрытом Skype-чате. Обсуждение результатов, рекомендации - все это входит в стоимость курса.
<br>Стоимость 14 000 руб.<br>Количество мест <span>ограничено!</span></p>
          <!--timer  
...
<p class="hellotimercopy"></p>
          ...
          <!--  <form role="form" name="form_2" onSubmit="return false;">
		   ...
		   <a href="https://goo.gl/xQiNhN" class="btn btn-danger btn-lg btn-block" rel="nofollow noopener" target="_blank">Записаться</a>
  ...
  <div class="preimushestva">
   ...
   <div><b>Илья Коровин</b></br>
    ...
    <div class="row">
	 ...
	 <h2>Программа вебинара "Торговля временем на опционах" </h2><br> 
 <ul class="neznanie_zakona">
<li style="font-weight:bold">День 1-ый (упор на теорию):</li>
<ul>
<li style="font-style:italic">Введение в теорию опционов:</li>
<ul>
<li>Фьючерсы и опционы на фьючерс. Срок жизни опциона. Страйки. Пут и Колл.</li>
<li>Как формируется цена на опцион. Внутренняя и внешняя стоимость.</li>
<li>Волатильность и теоретическая цена.</li>
<li>Греки (тета, гамма, дельта, вега).</li>
</ul>
<li style="font-style:italic">Опционы, как частный случай Торговли Временем:</li>
<ul>
<li>Опционы против стопов. Покупка волатильности. Преимущества и недостатки на практике.</li>
<li>Опционы против прогноза рынков. Продажа волатильности. Преимущества и недостатки на практике.</li>
<li>Психология и многомерность опционной торговли.</li>
</ul>
<li style="font-style:italic">Основные опционные стратегии.</li>
<ul>
<li>Бычий колл-спред. Медвежий колл-спред. Пут-спреды.</li>
<li>Пропорциональные колл и пут спреды.</li>
<li>Обратные пропорциональные колл и пут спреды.</li>
<li>Стрэп и Стрип.</li>
<li>Стреддл. Покупка и продажа.</li>
<li>Стренгл. Покупка и продажа.</li>
<li>Бабочка. Покупка и продажа.</li>
<li>Кондор. Покупка и продажа.</li>
</ul>
<li style="font-style:italic">Ответы на вопросы. (21:00-22:00)</li>
 </ul>
  <li style="font-weight:bold"><br>День 2-ой (упор на практику):</li>
<ul>
<li style="font-style:italic">Готовим рабочее место “Quik” под торговлю опционами:  </li>
<ul>
<li>Доска опционов.</li>
<li>Графики и стаканы опционов.</li>
<li>Графики волатильности и теоретической цены.</li>
<li>Состояние счета. ГО. Вариационка.</li>
  </ul>
<li style="font-style:italic">Практические особенности торговли опционами:</li>
<ul>
<li>Расчеты ГО и вариационки. Клиринг дневной и вечерний. Равновесная точка. Работа с деском.</li>

<li>Ликвидность и теоретическая цена.</li>
<li>Тета и волатильность. Место для точки входа.</li>
</ul>
 
<li style="font-style:italic">Программа “Опционный аналитик”:</li>
<ul>
<li>Как заносить данные в программу.</li>
<li>Как работать с программой.</li>
</ul>
<li style="font-style:italic">Практикум:</li>
<ul>
<li>Отслеживание и анализ информации по трем графикам и Доске Опционов.</li>
<li>Выставление заявок.</li>
<li>Совершение реальных сделок онлайн.</li>
</ul>
<li style="font-style:italic">Полезная информация:</li>
<ul>
<li>Синтетические спреды. Арбитраж пут-колл.</li>
<li>Улыбка волатильности.</li>
<li>Скорость падения теты от страйка и даты экспирации.</li>
<li>Краткая промо-информация на платный курс “Прикрытый интрадей” - как самую идеальную опционную стратегию “Торговли Временем”, позволяющую стабильно зарабатывать при любом состоянии рынка без необходимости прогнозировать рынок и без временного залипания и высиживания цены.</li>
</ul>
<li style="font-style:italic">Ответы на вопросы. (21:00-22:00)</li>
</ul>
  ...
  <div id="how-work">
    <div id="tarif">
      <h6 style="text-align: center;"><span style="color:#ffffff">Преимущества Курса:</span></h6>
		...
		<li>Этот курс позволит вам войти в интереснейший и многомерный мир опционов не в одиночку, а за руку с опытным наставником-практиком.</li>
<li>Вы сможете в кратчайшие сроки овладеть практическими способами торговли опционами непосредственно применительно к ФОРТСУ (а не абстрактной теорией о торговле опционами на других рынках, как описано во всей доступной литературе по этим темам, и что далеко не всегда адаптируется для практики нашего рынка).</li>
<li>Вы получите основные знания об опционах и ключевых опционных стратегиях в максимально доступной форме, а также возможность в живом диалоге с наставником сразу разобрать непонятные для Вас моменты.</li>
<li>Вы получите возможность в онлайн режиме настроить рабочее место под опционы в торговом терминале и совершать реальные сделки с опционами, а также научитесь пользоваться аналитическим опционным софтом.<li>
<li>Вы узнаете ключевые нюансы работы с опционами, с которыми обычно сталкиваются неподготовленные новички и незнание которых приводит их к серьезным проблемам и куче потерянного времени и денег (особенности расчета ГО и вариационки, клиринга и экспирации, падения теты, подводные камни покупки и продажи волатильности, особенности психологии торговли опционами и сложности перестройки сознания после двухмерного спотового рынка в многомерный опционный мир).</li>



<h6 style="text-align: center;">Что Вы получите после прохождения Курса:</h6>
     
<li>Вы поймете, почему именно опционы являются самым идеальным способом “Торговли Временем” из всех существующих способов и инструментов торговли на всех финансовых рынках.<li>
<li>Вы узнаете базовые способы практического применения “Торговли Временем” и торговли опционами конкретно на ФОРТСЕ.<li>
<li>Вы получите необходимую теоретическую и практическую базу для того, чтоб суметь в максимально полной мере воспринять следующий авторский курс “Прикрытый интрадей” - стратегию, которая перевернет ваше представление о значимости рыночных прогнозов, о рисках, и матожидании прибыли. Которая позволит вам из потенциальной жертвы на рынке превратиться в охотника и извлекать прибыль из любых движений рынка, не пытаясь его предсказывать.<li>
...
<li style="text-align: center;"><br>Стоимость: 14 000 рублей</li>
